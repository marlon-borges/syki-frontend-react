    ...
    'rounded-lg flex items-center justify-center w-fit shrink-0 gap-1.5 cursor-pointer',
    {
      ...
      compoundVariants: [
        ...
        },
        {
          ...
          variant: 'outline',
          class:
            'bg-transparent text-t-accent border border-purple-200 hover:bg-b-accent-muted disabled:border-neutral-200 disabled:bg-transparent disabled:text-t-disabled disabled:cursor-default focus-visible:ring-2 focus-visible:ring-neutral-200 focus-visible:ring-offset-b-default focus-visible:ring-offset-2 focus-visible:outline-none',
        },
        {
          color: 'primary',
          variant: 'ghost',
          class:
            'bg-transparent text-t-accent hover:bg-b-accent-muted disabled:bg-transparent disabled:text-t-disabled disabled:cursor-default focus-visible:ring-2 focus-visible:ring-neutral-200 focus-visible:ring-offset-2 focus-visible:ring-offset-b-default focus-visible:outline-none',
        },
        {
          color: 'primary',
          variant: 'link',
        ...
        },
        {
          ...
          variant: 'ghost',
          class:
            'bg-transparent text-t-success hover:bg-b-success-muted hover:dark:bg-green-50 disabled:bg-transparent disabled:text-t-disabled disabled:cursor-default focus-visible:ring-2 focus-visible:ring-neutral-200 focus-visible:ring-offset-2 focus-visible:ring-offset-b-default focus-visible:outline-none',
        },
        {
          color: 'success',
          variant: 'link',
        ...
        },
        {
          ...
          variant: 'outline',
          class:
            'bg-transparent text-t-error border border-red-200 hover:bg-b-error-muted hover:dark:bg-b-error disabled:border-neutral-200 disabled:bg-transparent disabled:text-t-disabled disabled:cursor-default focus-visible:ring-2 focus-visible:ring-neutral-200 focus-visible:ring-offset-b-default focus-visible:ring-offset-2 focus-visible:outline-none',
        },
        {
          color: 'error',
          variant: 'ghost',
